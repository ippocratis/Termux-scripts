...
# Function to force install missing packages
...
# Force install packages before importing them
def ensure_dependencies():
    packages = ['requests', 'tqdm', 'argparse']
...
def search_repos_and_check_apk(search_query):
    ...
    with tqdm(total=max_repos, desc="Checking repositories", unit="repo") as pbar:
